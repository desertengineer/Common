...
document.addEventListener('DOMContentLoaded', function () {
    loadApps();
    document.getElementById('app-modal').querySelector('.close-btn').onclick = function () {
        var e = document.getElementById('app-modal');
        e.style.display = 'none', e.querySelector('.youtube-frame').src = ''
    };
    document.getElementById('app-modal').querySelector('.left-arrow').onclick = function () {
        currentIndex > 0 && openModal(currentIndex - 1)
    };
    document.getElementById('app-modal').querySelector('.right-arrow').onclick = function () {
        currentIndex < appsData.length - 1 && openModal(currentIndex + 1)
    };
    document.getElementById('app-modal').onclick = function (e) {
        e.target === this && (this.style.display = 'none', this.querySelector('.youtube-frame').src = '')
    }
});
