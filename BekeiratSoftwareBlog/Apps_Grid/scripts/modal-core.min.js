...
function loadApps() {
    fetch('https://desertengineer.github.io/Common/BekeiratSoftwareBlog/Apps_Grid/data/AppsGrid_ver.04.xml').then(function (e) {
        ...
        renderApps(appsData), setupFilters(appsData), setupModalEvents()
    })
}
...
function openModal(e) {
    ...
    var o = t.youtube;
    o && o.indexOf('youtube.com/embed/') !== -1 ? n.querySelector('.youtube-frame').src = o : n.querySelector('.youtube-frame').src = '', document.querySelector('.app-modal').style.display = 'flex!important';
